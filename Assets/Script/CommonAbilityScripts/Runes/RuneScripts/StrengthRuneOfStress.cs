...
public class StrengthRuneOfStress : MonoBehaviour, IRuneScript
{
    ...
    {
        _entityEvents.RemoveBuff("StrengthRuneOfBladeArmor");
        _entityEvents.RemoveBuff("StrengthRuneOfBladeWeapon");

        if (duplicateCountArmor != 0)
        {
            _entityEvents.NewBuff("StrengthRuneOfBladeArmor", EntityStats.BuffType.HealthMultiplier, (int)Mathf.Pow(0.8f, duplicateCountArmor));
            _entityEvents.NewBuff("StrengthRuneOfBladeArmor", EntityStats.BuffType.PhysicalDamageMultiplier, (int)Mathf.Pow(1.25f, duplicateCountArmor));
        }

        if (duplicateCountWeapon != 0)
        {
            _entityEvents.NewBuff("StrengthRuneOfBladeWeapon", EntityStats.BuffType.HealthMultiplier, (int)Mathf.Pow(0.8f, duplicateCountWeapon));
            _entityEvents.NewBuff("StrengthRuneOfBladeWeapon", EntityStats.BuffType.PhysicalDamageMultiplier, (int)Mathf.Pow(1.25f, duplicateCountWeapon));
        }
    }
    ...
    {
        if (_entityEvents != null) _entityEvents.RemoveBuff("StrengthRuneOfBladeArmor");
        if (_entityEvents != null) _entityEvents.RemoveBuff("StrengthRuneOfBladeWeapon");

...
public class AgilityRuneOfSpeed : MonoBehaviour, IRuneScript
{
    ...
    public void SetUpPermanentEffects()
    {
        ...
        _entityEvents.NewBuff("AgilityRuneOfSpeedBonus", EntityStats.BuffType.SpeedMultiplier, (duplicateCountArmor + duplicateCountWeapon) * 10);
    }

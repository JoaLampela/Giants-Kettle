...
public class StaffBasicAttack : MonoBehaviour, IAbility
{
    ...
    private void InstatiateHitBox()
    {
        ...
        GameObject basicAttack = Instantiate(GetComponent<EntityAbilityManager>().basicAttackStaff, (Vector2)transform.position + direction * 2, rotation);

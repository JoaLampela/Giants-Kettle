...
public class VitalityRuneOfTenacity : MonoBehaviour, IRuneScript
{
    ...
    {
        _entityEvents.RemoveBuff("VitalityRuneOfTenacityArmor");
        _entityEvents.RemoveBuff("VitalityRuneOfTenacityWeapon");

        if (duplicateCountArmor != 0)
        {
            _entityEvents.NewBuff("VitalityRuneOfTenacityArmor", EntityStats.BuffType.Tenacity, duplicateCountArmor * 20);
        }

        if (duplicateCountWeapon != 0)
        {
            _entityEvents.NewBuff("VitalityRuneOfTenacityWeapon", EntityStats.BuffType.Tenacity, duplicateCountWeapon * 20);
        }
    }
    ...
    {
        if (_entityEvents != null) _entityEvents.RemoveBuff("VitalityRuneOfTenacityArmor");
        if (_entityEvents != null) _entityEvents.RemoveBuff("VitalityRuneOfTenacityWeapon");

...
public class SpiritRuneOfHealing : MonoBehaviour, IRuneScript
{
    ...
    public void SetUpPermanentEffects()
    {
        ...
        {
            _entityEvents.NewBuff("SpiritRuneOfHealingArmor", EntityStats.BuffType.SpellHaste, duplicateCountArmor * 10);
        }
